...
%   28/09/2011    SOH Madgwick    Initial release
    ...
    for i = 1:2:nargin
        ...
        elseif  strcmp(varargin{i}, 'MagWeight'),    obj.MagWeight    = varargin{i+1};
        elseif  strcmp(varargin{i}, 'AccWeight'),    obj.AccWeight    = varargin{i+1};
        else
            error('Invalid argument: %s', string(varargin{i}));
        end
    end
end
        function obj = Update(obj, Gyroscope, Accelerometer, Magnetometer)
            ...
            eAcc = cross(Accelerometer, v);
            eMag = cross(Magnetometer, w);

            % Mag weight change
            e = obj. AccWeight * eAcc + obj.MagWeight * eMag;
