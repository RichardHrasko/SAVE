function out = detailed(Turndetection, right, left, gps, folder)

    out.overall = StatsOverall(Turndetection, right, left, gps);
...
Turndetection_i.intervals.t = [t1 t2];
        ...
        out.intervals(i).stats = StatsOverall(Turndetection_i, right_i, left_i, gps_i);
